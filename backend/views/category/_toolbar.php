<div class="btn-toolbar">
    ...
    $this->widget("bootstrap.widgets.TbButton", array(
        ...
        'buttons'=>array(
                array('label'=>Yii::t('crud','Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'parent - Category', 'url' =>array('//category/admin')),array('label'=>'categories - Category', 'url' =>array('//category/admin')),array('label'=>'news - News', 'url' =>array('//news/admin')),array('label'=>'pages - Page', 'url' =>array('//page/admin')),
            )
          ),
        ),
    ));
